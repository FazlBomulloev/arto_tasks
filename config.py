...
DB_CONFIG = {
    ...
    'password': os.getenv('REDIS_PASSWORD', Path('vars/db_password.txt').read_text().strip()),
...
# === Redis ===
REDIS_HOST = os.getenv('REDIS_HOST', '92.255.76.235')
REDIS_PORT = int(os.getenv('REDIS_PORT', '6379'))
REDIS_PASSWORD = os.getenv('REDIS_PASSWORD', Path('vars/password.txt').read_text().strip().split(':')[0])
